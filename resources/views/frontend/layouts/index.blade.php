<x-front-app-layout>
    ...
    <section class="slider_section">
        <div class="slider_area owl-carousel">
            ...
            @empty
            <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('front-asset/assets/img/slider/slider2.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="slider_content">
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('front-asset/assets/img/slider/slider3.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="slider_content">
                                            ...
                                            <figure>
                                                <div class="product_thumb">
                                                    ...
                                                    <div class="action_links">
                                                        <ul>
                                                            <li class="add_to_cart"><a href="{{ route('cart.index') }}"
            ...
            <div class="product_banner_container">
                <div class="row">
                    <div class="col-lg-4 col-md-5">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{ asset('front-asset/assets/img/product/9.jpeg') }}"
                                    alt="" style="height: 820px!important"></a>
                        </div>
                    </div>
                                ...
                                <article class="single_product">
                                    <figure>
                                        ...
                                        <figcaption class="product_content">
                                            ...
                                            <p><a href="#">{{ $product->category->name }}</a></p>
                                            <div class="price_box">
                                                <span class="current_price">BDT&nbsp; {{ $product->purchase_price }}</span>
                                                {{-- <span class="old_price">$257.00</span> --}}
                                            </div>
                                        </figcaption>
                                    </figure>
                ...
                <div class="col-12">
                    ...
                    <div class="brand_container owl-carousel ">
                        ...
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset($brand->image) }}" style="height: 50px!important"
                                    alt=""></a>
                        </div>
                        @empty
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('front-asset/assets/img/brand/brand2.jpg') }}"
                                    alt=""></a>
                        </div>
                        @endforelse
                    </div>
