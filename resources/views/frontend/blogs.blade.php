                                ...
                                <article class="single_blog">
                                    <figure>
                                        ...
                                        <figcaption class="blog_content">
                                            ...
                                            <h4 class="post_title"><a href="{{ route('blog.details', $blog->id) }}">{{ substr($blog->short_description, 0, 60) }}</a></h4>
                                            <div class="articles_date">
                                                <p>{{ isset($blog->created_at) ? $blog->created_at->diffForHumans() : '00/00/0000' }} | <a href="#">{{ $blog->category }}</a> </p>
                                            </div>
                                        </figcaption>
                                    </figure>
                                </article>
